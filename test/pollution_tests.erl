...
createMonitor_test_() ->
  ?_assertEqual(maps:size(pollution:createMonitor()), 0).
...
addStation_test_() ->
  ...
  ?_assertEqual(M2, #{{1, 1} => #{name => "Krakow"}}).
...
addStation2_test_() ->
  ...
  ?_assertEqual(M3, {error, duplicated_station}).
...
addValue2_test_() ->
  ...
  ?_assertEqual(M3, {error, no_station}).
...
addValue3_test_() ->
  ...
  ?_assertEqual(M4, {error, duplicated_value}).
...
getOneValue3_test_() ->
  ...
  ?_assertEqual(M7, {error, no_value}).
...
getStationWithTheMostMeasurements2_test_() ->
  ...
  ?_assertEqual(M2, {error, empty_monitor}).
...
getNearestStation_test_() ->
  ...
  [?_assertEqual(Station1, {1, 3}),
  ?_assertEqual(Station2, {3, 3}),
  ?_assertEqual(Station3, {3, 2})].
...
getNearestStation4_test_() ->
  ...
  [?_assertEqual(StationError1, {error,just_one_station}),
  ?_assertEqual(StationError2, {error,no_station})].
